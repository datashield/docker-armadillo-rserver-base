...
The purpose of the docker image generate by this configuration is intended to support the InterConnect Project.
...
- [dsMediation](https://github.com/datashield/dsMediation/tree/0.0.3) 0.0.2
- [dsSynthetic](https://github.com/tombisho/dsSynthetic) 0.0.2
- [dsSurvival](https://github.com/neelsoumya/dsSurvival) v2.1.0
...
`docker run -e DEBUG=TRUE datashield/docker-armadillo-rserver-base/development/armadillo-rserver_edam-terrain:1.0.0`
